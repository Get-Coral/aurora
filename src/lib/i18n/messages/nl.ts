...
export const nlMessages: MessageDictionary = {
  ...
  'settings.aboutCopy': 'Aurora is een open-source interface voor Jellyfin. Bug gevonden of een idee? We horen graag van je.',
  ...
  'pwa.offlineCopy': 'Aurora kan nog steeds gecachete schermen en artwork tonen, maar streaming playback heeft een live verbinding met Jellyfin nodig.',
  'pwa.offlineAction': 'Offline scherm openen',
  'pwa.retryAction': 'Opnieuw proberen',
  'pwa.offlineBannerTitle': 'Je bent offline',
  'pwa.offlineBannerCopy': 'Gecachete pagina’s blijven beschikbaar, maar playback en live bibliotheekupdates hebben een verbinding nodig.',
