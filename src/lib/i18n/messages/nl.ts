...
export const nlMessages: MessageDictionary = {
	...
	"player.quality": "Kwaliteit",
	"player.qualityAuto": "Automatisch",
	"player.qualityAdaptive": "Past zich aan je verbinding aan",
	...
	"profiles.passwordFor": (params) => `Wachtwoord voor ${params?.name}`,
	"profiles.passwordSubmit": "Doorgaan",
	"profiles.passwordChecking": "Controleren…",
	"profiles.passwordCancel": "Annuleren",
	...
	"login.title": "Aanmelden bij Aurora",
	"login.subtitle": "Deze Aurora-instantie vereist dat je je aanmeldt met je Jellyfin-account.",
	"login.username": "Gebruikersnaam",
	"login.password": "Wachtwoord",
	"login.hint": "Gebruik dezelfde gebruikersnaam en hetzelfde wachtwoord als voor Jellyfin.",
	"login.submit": "Aanmelden",
	"login.signingIn": "Bezig met aanmelden…",
	"login.errorFallback": "Aurora kon je niet aanmelden.",
	"settings.securitySection": "Beveiliging",
	"settings.security.requireLogin": "Aanmelden verplichten",
	"settings.security.requireLoginCopy":
		"Vraag iedereen om zich aan te melden met hun Jellyfin-gebruikersnaam en -wachtwoord voordat ze kunnen bladeren of streamen. Aanbevolen wanneer Aurora bereikbaar is vanaf het internet.",
	"settings.security.lockedNote":
		"Geforceerd ingeschakeld via de omgevingsvariabele AURORA_REQUIRE_LOGIN.",
	"profile.avatar.title": "Profielfoto",
	"profile.avatar.copy": "Upload een afbeelding of kies er een uit titels die je hebt bekeken.",
	"profile.avatar.change": "Foto wijzigen",
	"profile.avatar.remove": "Foto verwijderen",
	"profile.avatar.upload": "Uploaden",
	"profile.avatar.fromPosters": "Posters",
	"profile.avatar.fromActors": "Acteurs",
	"profile.avatar.uploadCta": "Afbeelding kiezen",
	"profile.avatar.uploadHint":
		"Afbeeldingen worden bijgesneden tot een vierkant en verkleind naar 512px voor uploaden.",
	"profile.avatar.saving": "Bezig met opslaan…",
	"profile.avatar.loading": "Suggesties laden…",
	"profile.avatar.postersEmpty": "Nog geen posters van je recent bekeken titels.",
	"profile.avatar.actorsEmpty": "Nog geen castfoto's van je recent bekeken titels.",
	"profile.avatar.error": "Er ging iets mis bij het bijwerken van je foto.",
