...
export const enMessages: MessageDictionary = {
	...
	"profiles.passwordFor": (params) => `Password for ${params?.name}`,
	"profiles.passwordSubmit": "Continue",
	"profiles.passwordChecking": "Checking…",
	"profiles.passwordCancel": "Cancel",
	...
	"profile.currentPasswordPlaceholder": "Leave blank if your server allows admin reset",
	...
	"login.title": "Sign in to Aurora",
	"login.subtitle": "This Aurora instance requires you to sign in with your Jellyfin account.",
	"login.username": "Username",
	"login.password": "Password",
	"login.hint": "Use the same username and password you use for Jellyfin.",
	"login.submit": "Sign in",
	"login.signingIn": "Signing in…",
	"login.errorFallback": "Aurora could not sign you in.",
	"settings.securitySection": "Security",
	"settings.security.requireLogin": "Require sign-in",
	"settings.security.requireLoginCopy":
		"Ask everyone to sign in with their Jellyfin username and password before they can browse or stream. Recommended when Aurora is reachable from the internet.",
	"settings.security.lockedNote": "Forced on by the AURORA_REQUIRE_LOGIN environment variable.",
	"profile.avatar.title": "Profile photo",
	"profile.avatar.copy": "Upload an image or pick one from titles you've watched.",
	...
	"profile.avatar.fromActors": "Actors",
	"profile.avatar.uploadCta": "Choose image",
	"profile.avatar.uploadHint":
		"Images are cropped to a square and scaled down to 512px before uploading.",
	"profile.avatar.saving": "Saving…",
	"profile.avatar.loading": "Loading suggestions…",
	"profile.avatar.postersEmpty": "No posters from your recent watches yet.",
	"profile.avatar.actorsEmpty": "No cast photos from your recent watches yet.",
	"profile.avatar.error": "Something went wrong while updating your photo.",
