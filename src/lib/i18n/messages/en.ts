...
export const enMessages: MessageDictionary = {
  ...
  'settings.aboutCopy': "Aurora is an open-source front-end for Jellyfin. Found a bug or have an idea? We'd love to hear from you.",
  ...
  'pwa.offlineCopy': 'Aurora can still show cached screens and artwork, but streaming playback needs a live connection to Jellyfin.',
  'pwa.offlineAction': 'Open offline screen',
  'pwa.retryAction': 'Try again',
  'pwa.offlineBannerTitle': 'Offline right now',
  'pwa.offlineBannerCopy': 'Cached pages are still available, but playback and live library updates need a connection.',
