		...
		<main className="library-shell">
			...
			<div className="page-wrap library-head" style={{ position: "relative", zIndex: 1 }}>
				<div className="library-copy">
					...
					{collection.overview ? <p className="library-summary">{collection.overview}</p> : null}
			...
			<div
				className="page-wrap library-footer library-footer-compact"
			...
			{addDialogOpen ? (
				<div
					className="coll-dialog-backdrop"
				...
				>
					...
					>
										...
										>
											...
											<div className="coll-result-copy">
												...
												<span>
													{[
														result.year,
														result.type === "series" ? t("search.series") : t("search.movie"),
													]
														.filter(Boolean)
														.join(" · ")}
												</span>
						...
						{addMutation.error ? <p className="detail-empty">{String(addMutation.error)}</p> : null}
